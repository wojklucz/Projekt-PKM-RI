...
# -*- coding: utf-8 -*-
"""
Wersja do zatrzymania na zwrotnicy 302 na Wrzeszczu w celu nagrania filmiku z hamowania. Żeby zatrzymać pociąg nr X, należy przejść do
funkcji ustawHamowanie i zmienić indeks na X-1. Żeby uruchomić należy zmienić nazwę tego pliku na PKMMap.py.
"""
...
class Map(QtGui.QWidget):
    ...
    def __init__(self,busControl,kom):
        ...
        self.xsize = 10
        self.skala = 1
        self.czasyStania = [0, 0, 0, 0, 0, 0, 0, 0]
        self.czasyStaniaPocz = [0, 0, 0, 0, 0, 0, 0, 0]
    ...
    def ustawHamowanie(self, bal):
        ...
        if bal == 42:
            self.czasyStania[0] = t.time()
            self.czasyStaniaPocz[0] = t.time() + 999
